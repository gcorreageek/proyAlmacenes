...
<div class="control-group">
	<div  class="form-inline ">
		<label class="control-label" for="inputObservacionIIS">Observaci&oacute;n IIS</label>
		<textarea rows="1" class="span10"  id="inputObservacionIIS" placeholder="Observaci&oacute;n IIS"   disabled></textarea>  
	</div>
</div>
