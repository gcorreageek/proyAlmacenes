...
<div class="controls">
<input type="text" id="inputCategoria"  name="objProducto.categoria" value="${objProducto.categoria}" placeholder="Categoria">
</div>
</div>
<div class="control-group">
<label class="control-label" for="inputMarca">Marca</label>
<div class="controls">
<input type="text" id="inputMarca"  name="objProducto.marca" value="${objProducto.marca}" placeholder="Marca">
</div>
</div>
<div class="control-group">
<label class="control-label" for="inputUMedida">U.Medida</label>
<div class="controls">
<input type="text" id="inputUMedida"  name="objProducto.unidadMedida" value="${objProducto.unidadMedida}" placeholder="U.Medida">
</div>
</div>
