package com.almacen.prototipos.dinterna;
...
*/
public class InformeDevolucionRegistrarI_JInternalFrame extends JInternalFrame implements  ActionListener {
...
//	String titulo2[]={"CODIGO","MARCA","ELIMINAR","MODIFICAR"};
	 ...
	 public InformeDevolucionRegistrarI_JInternalFrame() { 
		 super("Informe de Devolucion Interna", true, true, true, true);
		 try { 
