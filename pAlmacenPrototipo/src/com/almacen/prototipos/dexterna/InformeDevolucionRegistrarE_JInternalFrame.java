package com.almacen.prototipos.dexterna;
...
*/
public class InformeDevolucionRegistrarE_JInternalFrame extends JInternalFrame implements  ActionListener {
...
//	String titulo2[]={"CODIGO","MARCA","ELIMINAR","MODIFICAR"};
	 ...
	 public InformeDevolucionRegistrarE_JInternalFrame() { 
		 super("Informe de Devolucion Externa", true, true, true, true);
		 try { 
			...
			this.setBounds(0, 0, 727, 526);
			{
				...
				getContentPane().add(pnlPrincipal, BorderLayout.CENTER);
				{
					...
					pnlArriba.setBounds(13, 74, 712, 194);
					{
...
//						jTable1.setModel(modelo2);
				...
				}
				{
					...
					jButton2.setBounds(288, 46, 196, 23);
				...
				}
				{
					...
					txtNroInforme.setText("INF201305254001");
				}
				{
					lblFecha = new JLabel();
