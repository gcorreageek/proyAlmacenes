...
*/
public class MarcaNueva_JDialog extends JDialog implements ActionListener {
...
//	 TranProducto objProd;
	 ...
	 public MarcaNueva_JDialog(Frame padre) {
		 // padre y modal
	    ...
	    try{
			...
			lblNombre.setPreferredSize(new java.awt.Dimension(54, 14));
