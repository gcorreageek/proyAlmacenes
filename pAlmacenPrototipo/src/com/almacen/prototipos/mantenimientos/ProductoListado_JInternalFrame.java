...
*/
public class ProductoListado_JInternalFrame extends JInternalFrame implements  ActionListener {
	...
	String titulo2[]={"COD","PRODUCTO","MARCA","UMEDIDA","[E]","[M]"};
...
//	String titulo2[]={"CODIGO","MARCA","ELIMINAR","MODIFICAR"};
	 ...
	 public ProductoListado_JInternalFrame() { 
		 super("Listado Producto", true, true, true, true);
		 try { 
