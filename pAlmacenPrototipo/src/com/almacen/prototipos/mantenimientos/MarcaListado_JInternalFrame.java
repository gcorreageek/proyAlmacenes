...
*/
public class MarcaListado_JInternalFrame extends JInternalFrame implements  ActionListener {
	...
	String titulo2[]={"CODIGO","MARCA","[E]","[M]"};
	 ...
	 public MarcaListado_JInternalFrame() { 
		 super("Listado Marca", true, true, true, true);
		 try { 
			...
			setVisible(true);
			{
				...
				}
				{
					...
					btnIngreso.setBounds(432, 9, 93, 21);
				...
				}
				{
					...
					btnBuscar.setBounds(432, 35, 93, 21);
