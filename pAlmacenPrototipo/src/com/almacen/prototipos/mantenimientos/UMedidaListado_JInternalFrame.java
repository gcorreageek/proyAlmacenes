...
*/
public class UMedidaListado_JInternalFrame extends JInternalFrame implements  ActionListener {
	...
	String titulo2[]={"COD","UMEDIDA","[E]","[M]"};
	 ...
	 public UMedidaListado_JInternalFrame() {  
		 super("Listado U.Medida", true, true, true, true);
		 try { 
